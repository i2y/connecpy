...
class Haberdasher(Protocol):
    ...
    def MakeSimilarHats(self, req: example_dot_haberdasher__pb2.Size, ctx: ServiceContext) -> AsyncIterator[example_dot_haberdasher__pb2.Hat]:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")
...
class HaberdasherASGIApplication(ConnecpyASGIApplication):
    def __init__(self, service: Haberdasher, *, interceptors: Iterable[ServerInterceptor]=(), max_receive_message_length=1024 * 100 * 100):
        super().__init__(
            endpoints={
                "/i2y.connecpy.example.Haberdasher/MakeHat": Endpoint[example_dot_haberdasher__pb2.Size, example_dot_haberdasher__pb2.Hat].unary(
                    service_name="Haberdasher",
                    name="MakeHat",
                    function=service.MakeHat,
                    input=example_dot_haberdasher__pb2.Size,
                    output=example_dot_haberdasher__pb2.Hat,allowed_methods=("GET", "POST"),
                ),
                "/i2y.connecpy.example.Haberdasher/MakeSimilarHats": Endpoint[example_dot_haberdasher__pb2.Size, example_dot_haberdasher__pb2.Hat].response_stream(
                    service_name="Haberdasher",
                ...
                "/i2y.connecpy.example.Haberdasher/DoNothing": Endpoint[google_dot_protobuf_dot_empty__pb2.Empty, google_dot_protobuf_dot_empty__pb2.Empty].unary(
                    service_name="Haberdasher",
                    name="DoNothing",
                    function=service.DoNothing,
                    input=google_dot_protobuf_dot_empty__pb2.Empty,
                    output=google_dot_protobuf_dot_empty__pb2.Empty,allowed_methods=("POST",),
                ),
            },
...
class HaberdasherSync(Protocol):
    def MakeHat(self, req: example_dot_haberdasher__pb2.Size, ctx: ServiceContext) -> example_dot_haberdasher__pb2.Hat:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")
    def MakeSimilarHats(self, req: example_dot_haberdasher__pb2.Size, ctx: ServiceContext) -> example_dot_haberdasher__pb2.Hat:
        raise ConnecpyException(Code.UNIMPLEMENTED, "Not implemented")
...
class HaberdasherWSGIApplication(ConnecpyWSGIApplication):
    def __init__(self, service: HaberdasherSync):
        super().__init__(
            endpoints={
                "/i2y.connecpy.example.Haberdasher/MakeHat": EndpointSync[example_dot_haberdasher__pb2.Size, example_dot_haberdasher__pb2.Hat](
                    service_name="Haberdasher",
                    name="MakeHat",
                    function=service.MakeHat,
                    input=example_dot_haberdasher__pb2.Size,
                ...
                "/i2y.connecpy.example.Haberdasher/MakeSimilarHats": EndpointSync[example_dot_haberdasher__pb2.Size, example_dot_haberdasher__pb2.Hat](
                    service_name="Haberdasher",
                    name="MakeSimilarHats",
                    function=service.MakeSimilarHats,
                    input=example_dot_haberdasher__pb2.Size,
                ...
                "/i2y.connecpy.example.Haberdasher/DoNothing": EndpointSync[google_dot_protobuf_dot_empty__pb2.Empty, google_dot_protobuf_dot_empty__pb2.Empty](
                    service_name="Haberdasher",
                    name="DoNothing",
                    function=service.DoNothing,
                    input=google_dot_protobuf_dot_empty__pb2.Empty,
