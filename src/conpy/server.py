...
class ConPyServer:
    """
    Represents a ConPy server that handles incoming requests and dispatches them to the appropriate endpoints.
    """
    ...
    def get_endpoint(self, path):
        ...
        Raises:
            ConPyServerException: If no handler is found for the path or if the service has no endpoint for the given method.
        """
