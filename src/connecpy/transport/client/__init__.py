"""Client Transport API for protocol-agnostic RPC clients.

WARNING: The Client Transport API is experimental and may change in future versions.
...
# Emit a warning when the client_transport module is imported
warnings.warn(
    "The Client Transport API is experimental and may change in future versions. "
    "Use with caution in production environments.",
    FutureWarning,
    stacklevel=2,
)
