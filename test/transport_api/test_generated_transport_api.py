...
@pytest.mark.skipif(
    sys.platform == "win32",
    reason="Test uses Unix-specific protoc invocation"
)
...
'''
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "from connecpy.transport.client.connect_async import ConnectTransportAsync" in content
        assert "from connecpy.transport.client.grpc_async import GrpcTransportAsync" in content
